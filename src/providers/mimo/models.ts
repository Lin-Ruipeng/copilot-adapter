...
export const MIMO_V2_6_PRO: ModelItem = {
  ...MIMO_BASE,
  id: 'mimo-v2.6-pro',
  label: 'MIMO V2.6 Pro',
  version: '2.6',
  ...
  imageInput: true,
  detailKey: 'model.mimo-v2.6-pro.detail',
  pricing: {
    USD: { default: { cacheInput: 0.0036, input: 0.435, output: 0.87 } },
    CNY: { default: { cacheInput: 0.025, input: 3.0, output: 6.0 } },
  },
...
export const MIMO_V2_6_FLASH: ModelItem = {
  ...MIMO_BASE,
  id: 'mimo-v2.6-flash',
  ...
  maxOutputTokens: 131_072,
  imageInput: true,
  detailKey: 'model.mimo-v2.6-flash.detail',
  pricing: {
...
export const MIMO_MODELS: readonly ModelItem[] = [MIMO_V2_6_PRO, MIMO_V2_6_FLASH];
